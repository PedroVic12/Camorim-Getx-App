...
import 'package:camorim_getx_app/app/pages/sistema%20Cadastro/views/mobile/db/consulta_banco_view.dart';
...
class _MobileCadastroSimplesRelatorioDigitalState
  ...
  Widget selectedCards() {
    final relatorio_controller = Get.find<CadastroController>();
    return Row(
      children: [
        Expanded(
          child: Padding(
